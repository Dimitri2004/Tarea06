...
*_En el archivo yml creamos la base de datos con imagen de mysql y realizamos el healthcheck y por ultimo asignamos su volumen _*
...
*_Ahora realizamos la configuracion de prestashop para que guarde dependencias de db y compruebe su estado con healthcheck y datos protegidos en el archivo .env_*
...
*_Por ultimo realizamos la creacion de phpmyadmin donde recoge volumenes de db y prestashop y realiza el healthcheck de db_*
...
*_Para realizar de forma segura su inicio necesitamos asegurar sus componentes para que el archivo .env oculto no revele datos importantes _*
